...
- Update `rubocop-rails` to 2.37
- Update `rubocop-performance` to 1.27

## [0.75.0] - 2026-08-16

- Update `rubocop` to 1.89
...
- Update `rubocop` to 1.87

## [0.70.0] - 2026-05-25

- Update `rubocop` to 1.86
- Update `rubocop-rails` to 2.35

## [0.69.0] - 2026-02-27

- Update `rubocop` to 1.85
...
- Update `rubocop` to 1.82.0
- Update `rubocop-rails` to 2.34
...
[unreleased]: https://github.com/rickselby/rubocop-rickselby/compare/v0.76.0...HEAD
...
[0.68.0]: https://github.com/rickselby/rubocop-rickselby/compare/v0.67.0...v0.68.0
...
[0.63.0]: https://github.com/rickselby/rubocop-rickselby/compare/v0.62.0...v0.63.0
[0.62.0]: https://github.com/rickselby/rubocop-rickselby/compare/v0.61.0...v0.62.0
